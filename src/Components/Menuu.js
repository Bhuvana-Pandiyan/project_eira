        ...
        <List>
          ...
          <ListItem disablePadding sx={{ display: 'block' }}  onClick={handleNavigate}>
            ...
            >
              ...
              <ListItemText primary="Roles List" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
        ...
        <List>
          ...
          <ListItem disablePadding sx={{ display: 'block' }}>
            ...
            >
              ...
              <ListItemText style={{ marginTop: "-120px" }} primary="Views" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
        </List>
        <List>
        ...
        <List>
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={handleNavigate} >
            ...
            >
              ...
              <ListItemText style={{ marginLeft: "-3px" }} primary="Tickets" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
