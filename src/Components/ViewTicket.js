    ...
    return (
        ...
        <div className="view">
          ...
          <input type= "date" onChange={e=>setDate(e.target.value)} style/>
                    ...
                    <Button variant="outlined" startIcon={< FiCheckCircle color="black" size="1rem" />} style={{
                        width: "100px",
                        color: "#505050", marginLeft: "165px", borderColor: "black", backgroundColor: "none", marginTop: "-57px"
                    }}>
                        Hold
                    </Button>
                    <Button variant="outlined" startIcon={< AiOutlineClose color="black" size="1rem" />} style={{ width: "100px", color: "black", marginLeft: "15px", borderColor: "black", backgroundColor: "none", color: "#505050", marginTop: "-57px" }}>
                        Close
                    </Button>
                </div>
            </div>
